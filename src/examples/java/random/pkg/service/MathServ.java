...
public class MathServ {
  ...
  public interface AsyncIface {
    ...
    public void add(long a, long b, AsyncMethodCallback<AsyncClient.add_call> resultHandler) throws TException;

    public void sub(long a, long b, AsyncMethodCallback<AsyncClient.sub_call> resultHandler) throws TException;
  ...
  public static class Client implements TServiceClient, Iface {
    ...
    public void send_sub(long a, long b) throws TException
    {
    ...
    public long recv_sub() throws TException
    {
      TMessage msg = iprot_.readMessageBegin();
      if (msg.type == TMessageType.EXCEPTION) {
        TApplicationException x = TApplicationException.read(iprot_);
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void add(long a, long b, AsyncMethodCallback<add_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class add_call extends TAsyncMethodCall {
      private long a;
      private long b;
      public add_call(long a, long b, AsyncMethodCallback<add_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
    ...
    public void sub(long a, long b, AsyncMethodCallback<sub_call> resultHandler) throws TException {
      checkReady();
      sub_call method_call = new sub_call(a, b, resultHandler, this, protocolFactory, transport);
      manager.call(method_call);
    }
    ...
    public static class sub_call extends TAsyncMethodCall {
      private long a;
      private long b;
      public sub_call(long a, long b, AsyncMethodCallback<sub_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.a = a;
        this.b = b;
      }
  ...
  public static class add_args implements TBase<add_args, add_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final TField B_FIELD_DESC = new TField("b", TType.I64, (short)2);
    ...
    public int compareTo(add_args other) {
      ...
      if (isSetA()) {        lastComparison = TBaseHelper.compareTo(this.a, typedOther.a);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
      ...
      if (isSetB()) {        lastComparison = TBaseHelper.compareTo(this.b, typedOther.b);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
  ...
  public static class sub_result implements TBase<sub_result, sub_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public sub_result setSuccess(long success) {
      this.success = success;
      setSuccessIsSet(true);
      return this;
    }
